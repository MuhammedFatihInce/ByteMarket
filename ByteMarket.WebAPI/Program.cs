...
{
	throw new Exception("KRÝTÝK HATA: appsettings.json içindeki 'SqlConnection' okunamadý! Lütfen ismini kontrol et.");
}

Log.Logger = new LoggerConfiguration()
	.MinimumLevel.Warning()
	.MinimumLevel.Override("ByteMarket", LogEventLevel.Information)
	.Enrich.FromLogContext()
	.Enrich.WithMachineName()
	.WriteTo.Console()
	.WriteTo.File("Logs/ByteMarket-log-.txt", rollingInterval: RollingInterval.Day)
	.WriteTo.MSSqlServer(
